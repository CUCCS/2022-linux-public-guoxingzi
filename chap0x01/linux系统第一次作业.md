...
- ## 调查并记录实验环境的如下信息：
  ...
  - ### 当前 Linux 内核版本信息
    ...
    ![第一张，ubuntu中查看版本信息](1.png)

    ![第二张，ubuntu中查看版本信息](2.png)
    ...
    ![第三张，centos环境中查看版本信息](3.png)

    ![第四张，centos环境中查看版本信息](4.png)

- ## Virtualbox 安装完 Ubuntu 之后新添加的网卡如何实现系统开机自动启用和自动获取 IP？

  1.在Ubuntu环境下是有目录的，可以通过语句`ls /etc/netplan/`来查看

  ![第五张，Ubuntu中查看netplan](5.png)

  2.在阿里云终端，centos环境中，运用语句可以发现，不存在目录。

  ![第六张，centos环境中查看netplan](6.png)
